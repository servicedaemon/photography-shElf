...
// (v1.4.1 retired /api/promote-favorites and /api/folder-mark. They
// duplicated /api/sort-in-place semantics and added a parallel mark-state
// system in `.favorites-state.json` that did the same job as the per-source
// state file. Sort handles favorite-mark routing identically — no need
// for two paths.)
