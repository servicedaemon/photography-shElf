...
| Platform                  | File                    | Notes                        |
| ------------------------- | ----------------------- | ---------------------------- |
| **macOS (Apple Silicon)** | `Shelf-1.2.3-arm64.dmg` | Native for M-series Macs     |
| **Windows 10/11**         | `Shelf-Setup-1.2.3.exe` | NSIS installer, x64          |
| **Linux — AppImage**      | `Shelf-1.2.3.AppImage`  | Universal, no install needed |
| **Linux — Debian/Ubuntu** | `shelf_1.2.3_amd64.deb` | `sudo dpkg -i`               |
...
1. Download `Shelf-Setup-1.2.3.exe` from the releases page.
...
1. Download `Shelf-1.2.3.AppImage` from the releases page.
2. `chmod +x Shelf-1.2.3.AppImage && ./Shelf-1.2.3.AppImage`
...
1. Download `shelf_1.2.3_amd64.deb` from the releases page.
2. `sudo dpkg -i shelf_1.2.3_amd64.deb`
